...
gulp.task("compile-fonts", function(){
    gulp.src(config.app.compiledLibsFonts)
...
gulp.task('compile', function(callback){
  runSequence(
            ["copy-html", "compile-libs" , "copy-assets", "compile-scripts",  "compile-styles","compile-fonts"],
            "inject",
            callback);
});
...
gulp.task('watch', function () {
  gulp.watch([config.app.baseHtml], ['compile']);
  gulp.watch([config.app.less], ['compile']);
  gulp.watch([config.app.scripts], ['compile']);
});
